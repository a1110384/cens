...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['setVol'] != 'undefined', 'missing Wasm export: setVol');
  assert(typeof wasmExports['init_audio'] != 'undefined', 'missing Wasm export: init_audio');
  assert(typeof wasmExports['stop_audio'] != 'undefined', 'missing Wasm export: stop_audio');
  ...
  _setVol = Module['_setVol'] = createExportWrapper('setVol', 1);
  _init_audio = Module['_init_audio'] = createExportWrapper('init_audio', 0);
  _stop_audio = Module['_stop_audio'] = createExportWrapper('stop_audio', 0);
